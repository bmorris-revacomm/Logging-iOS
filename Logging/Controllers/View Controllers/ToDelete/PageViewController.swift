...
//  Logging
//
//  Created by Pete Misik on 9/24/20.
    ...
    private func notifyPageDelegateOfNewIndex() {
        if let firstViewController = viewControllers?.first,
           let index = orderedViewControllers.firstIndex(of: firstViewController) {
                tutorialDelegate?.pagePageViewController(pagePageViewController: self, didUpdatePageIndex: index)
        }
    }
...
extension PagePageViewController: UIPageViewControllerDelegate {
...
protocol PagePageViewControllerDelegate: class {
    /**
    ...
    */
    func pagePageViewController(pagePageViewController: PagePageViewController,
